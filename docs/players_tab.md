...
| 6 | **Address Information** | The player's addresses information: *Country* (6.1), *City* (6.2), *Zipcode* (6.3), *Address lines 1 & 2* (6.4-6.5); *Residential Address* (6.6), *Residential Zipcode* (6.7), and *Residential City* (6.8) if this [fields is required on the site](#NEW_UI_BO_site_settings_manual.md-general-settings-14). |
