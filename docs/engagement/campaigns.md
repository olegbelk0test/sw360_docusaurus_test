...
| 8 | **Trigger Conditions** | Click [+ Add Condition] to add conditions that will trigger the campaign for the players from the [Attributions Tab](attributions-page-link). Choose Options or enter values for the selected audience:<p>![add_audience_gif](https://i.imgur.com/OAjkIkL.gif)</p><p>To delete the audience &mdash; press [x] near the needed row.</p> |
