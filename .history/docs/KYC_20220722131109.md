...
![kyc](https://i.imgur.com/6QzpMob.png)
...
| 4.2 | **KYC Status** | The statuses of the player's verifications: address, age, face, name, and source of funds.<p>KYC 0&mdash;none is verified</p><p>KYC 1&mdash;age, face, and name are verified</p><p>KYC 2&mdash;everything is verified.</p><p>Click the **[Change]** button to open the Change KYS Status Pop-Up and change the status:</p><p>![change_kyc_status_popup](https://i.imgur.com/GQrp8pm.png)</p> |
| 4.3 | **Player Status** | The current [player's status](/docs/players/player-profile/profile-header#player-statuses). |
| 4.4 | **Pending Documents previews** | The previews of the player's documents with the statuses on the top right:<p>⏳&mdash;uploaded, pending</p><p>✔&mdash;approved</p><p>❌&mdash;rejected, expired.</p><p>Click on the preview to open it (4.6).</p><p>Click the **[+Add Document]** button to the right to upload a new player's document in the pop-up window:</p><p>![upload-doc-kyc](https://i.imgur.com/Z94mKtm.png)</p><p>The operator can upload the image of the document, choose its [type](#document-types) and side.</p><p>Supported document types to upload: *.png, *.jpeg, *.jpg, *.tiff, *.pdf</p><p>Click [Add] to upload the document, or close the pop-up, or click [Discard Changes] and close the pop-up to cancel.</p> |
| 4.5 | **Document Image** | <p>The selected document image.</p><p>Click to open the fullscreen with the big image. Click again to enlarge the image and navigate the mouse to scroll through the image:</p><p>![kyc-image-big.gif](https://i.imgur.com/hzercZ1.gif)</p> |
| 4.6 | **Document Type** | Choose the type of the document from [the list](#document-types). |
| 4.7 | **Document Source** | Choose *backoffice* or *player*. |
| 4.8 | **Document Side** | Choose *any*, *front*, or *back*. |
| 4.9 | **Document Status** | Choose *uploaded*, *approved*, *rejected*, or *expired*. |
