...
| 3 | **Deposit Settings** | The deposit settings for the selected payment provider:<p>3.1 Min limit &mdash; </p><p>3.2 Max limit &mdash; </p><p>3.3 Deposit Tax Type &mdash; </p><p>3.4 Deposit Tax &mdash; </p><p>3.5 Deposit Fee Type &mdash; </p><p>3.6 Deposit Fee &mdash; </p><p>3.7 Deposit Fee Strategy &mdash; </p><p>3.8 Site Deposit Amounts Buttons &mdash; </p>. |
| 4 | **Withdraw Settings** | The withdraw settings for the selected payment provider.<p>These setting are the same as for the Deposit Settings.</p> |
