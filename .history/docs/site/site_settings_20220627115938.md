...
Hover on and click on the game provider name to open the provider options. The list of these options is taken from the server side and is different for each game provider:
