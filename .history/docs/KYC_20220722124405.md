...
![KYC](https://i.imgur.com/xeHGuQz.png)

| # | Field | Description |
|-|-|-|
| 1 | **KYC Left Menu Section** | <p>Click to open KYC Section.</p><p>The view of the page if there is no documents to check:</p><p>![kyc_empty](https://i.imgur.com/udfjQal.png)</p> |
...
| 5 | **Player Profile Information** | The general information about the player.<p>Click the ![edit_button](https://i.imgur.com/yZCKHoP.png) **Edit** button to the right to enter the edit mode and change the information according to the pending documents if needed to.</p> |
| 6 | **Request Documents** Section | <p>This section allows the operator to send request email to the player with the list of the needed documents.</p><p>Click *Request Documents* to send to the player documents request by email.</p><p>Select in the opened pop-up the needed document types, add the optional message to the player, and confirm the request:</p><p>![request_docs.gif](https://i.imgur.com/AnBnvYd.gif)</p><p>The "Waiting for documents" radiobutton is located at the bottom of the list.</p><p>Enable it and save changes if you are waiting for some documents from the player.</p> |
| 7 | **Discard Changes** | Click to discard entered changes. |
| 8 | **Save** | Click to apply and save changes. |

## KYC Main Section

![kyc](https://i.imgur.com/rbxZaQw.png)
