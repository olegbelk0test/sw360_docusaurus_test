...
![bo_profile_validation_tab](https://i.imgur.com/0YBNI4c.png)
...
![verify_docs](https://i.imgur.com/j5TzDti.png)

| # | Field | Description |
|-|-|-|
| 1.1 | **Request Documents** Button | <p>Click to send to the player documents request by email.</p><p>Select in the opened pop-up the needed document types, add the optional message to the player, and confirm the request:</p><p>![request_docs.gif](https://i.imgur.com/ouffJjl.gif)</p> |
...
| 1.6 | **Document Side** | Choose *any*, *front*, or *back*. |
| 1.7 | **Document Status** | Choose *uploaded*, *approved*, *rejected*, or *expired*. |
| 1.8 | **Rotate buttons** | Click to rotate the image 90° clockwise or counterclockwise. |
| 1.9 | **Delete Document** | Click to delete the current document You need to approve or cancel the action at the pop-up window. |
| 1.10 | **Created and Last Updated Information** | The information about who(the operator or the player) and when (date&time) created and last edited the opened document. |
