...
| 2 | **Player Profile Information** | The general information about the player.<p>Click the ![edit_button](https://i.imgur.com/yZCKHoP.png) Edit button to the left to enter the edit mode and change the information according to the pending documents if needed to.</p><p>The "Requested for documents" checkbox is located at the bottom of the list.</p><p>Enable it if you are waiting for some documents from the player.</p> |
