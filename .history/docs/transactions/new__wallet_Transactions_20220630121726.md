...
| **Binding Ref** | <p>The external transaction ID.</p><p>Click to open [Wallet Transaction Details for this player](/docs/players/player-profile/profile-payments-tab#transaction-details-page).</p><p>hover on.</p> |
| **Unique Ref** | . |
